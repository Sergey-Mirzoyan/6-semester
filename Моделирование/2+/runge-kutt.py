...
do_plot(pltMasT, pltMasI4,  pltMasI2, 't, сек',  'I, А', '4-й порядок', '2-й порядок')
do_plot(pltMasT, pltMasU4,  pltMasU2, 't, сек', 'Uc, В', '4-й порядок', '2-й порядок')
do_plot(pltMasT, pltMasRp4, pltMasRp2,'t, сек', 'Rp, Ом', '4-й порядок', '2-й порядок')

for i in range(len(pltMasI4)):
    pltMasI4[i] *= pltMasRp4[i]
    pltMasI2[i] *= pltMasRp2[i]

do_plot(pltMasT, pltMasI4, pltMasI2, 't, сек', 'Up, В', '4-й порядок', '2-й порядок')
