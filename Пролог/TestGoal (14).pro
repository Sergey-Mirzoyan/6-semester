...
predicates
        ...
        search(mark, color, name, city, telephone, bank).
...
clauses
        ...
        search(Mark, Color, Name, City, Telephone, Bank) :- car(Name, Mark, Color, _), abonent(Name, Telephone, adress(City, _, _, _)), bank(Name, Bank, _, _).

goal
	search(toyota, white, Name, City, Telephone, Bank).
